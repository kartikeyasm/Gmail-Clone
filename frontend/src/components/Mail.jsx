  ...
  return (
    <div className='flex-1 bg-white rounded-xl mx-5'>
        ...
        <div className='h-[90vh] overflow-y-auto p-4'>
            ...
            <div className='my-10'>
                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Veniam cupiditate omnis enim vel, nemo, magnam rem explicabo accusamus nulla animi hic exercitationem aliquam fugit! Necessitatibus vitae dicta consequuntur assumenda optio?</p>
            </div>
